...
# if col1.button("렌더링 결과 확인", key="button1", help="버튼 1"):
#     col1.markdown("렌더링 결과를 로딩 중입니다...1")

# if col2.button("렌더링 결과 확인1", key="button2", help="버튼 2"):
#     col2.markdown("렌더링 결과를 로딩 중입니다...2")

# if col3.button("렌더링 결과 확인2", key="button3", help="버튼 3"):
#     col3.markdown("렌더링 결과를 로딩 중입니다...3")
...
<div class="centered">
    ...
    <ol>
        ...
        <li><strong>차량 3D시각화</strong>: 3D시각화를 사용하려는 경우, 가이드 동영상을 확인하고 파일을 업로드하여 결과물을 확인할 수 있습니다.</li>
    </ol>
</div>
""", unsafe_allow_html=True)
...
<div class="centered">
    ...
    <ol>
        ...
        <li><strong>평균 중고 가격</strong>: 해당 차량의 평균 중고 가격을 제공합니다. 이 정보는 참고용으로만 사용되며 실제 가격과 다를 수 있습니다.</li>
    </ol>
</div>
""", unsafe_allow_html=True)
...
# 여기에 렌더링 결과 및 제원 정보 확인 로직을 추가하면 됩니다.
